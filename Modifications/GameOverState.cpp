...
namespace SSEngine
{
    ...
    void GameOverState::Init()
    {
        ...
        m_BackgroundSprite.setTexture( this->m_Data->assets.GetTexture( "Game Over Background" ));
        m_GameOverTitle.setTexture( this->m_Data->assets.GetTexture( "Game Over Title" ));
        m_GameOverContainer.setTexture( this->m_Data->assets.GetTexture( "Game Over Body" ));
        m_RetryButton.setTexture( this->m_Data->assets.GetTexture( "Play Button" ));
