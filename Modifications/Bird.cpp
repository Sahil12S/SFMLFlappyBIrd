...
namespace SSEngine
{
    Bird::Bird(GameDataRef data) : m_Data ( std::move(data) )
    {
        ...
        m_AnimationFrames.push_back( m_Data->assets.GetTexture( "Bird Frame 1" ) );
        m_AnimationFrames.push_back( m_Data->assets.GetTexture( "Bird Frame 2" ) );
        m_AnimationFrames.push_back( m_Data->assets.GetTexture( "Bird Frame 3" ) );
        m_AnimationFrames.push_back( m_Data->assets.GetTexture( "Bird Frame 4" ) );
